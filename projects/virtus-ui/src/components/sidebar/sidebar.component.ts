...
import { VirtusSidebarService } from './sidebar.service';

@Component({
  selector: 'vui-sidebar',
  templateUrl: './sidebar.component.html',
})
export class VirtusSidebarComponent implements OnInit {
  constructor(protected sidebarService: VirtusSidebarService) {}
