...
export class VelocityDropdownComponent implements AfterContentInit, OnDestroy {
  @Input() hoverMode: boolean = false;

  @ViewChild('wrapper', { static: true }) wrapper!: ElementRef;
  @ContentChild(VelocityDropdownToggleDirective, { static: true })
  toggleDirective!: VelocityDropdownToggleDirective;
